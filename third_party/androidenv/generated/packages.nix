...

{
  ...
  "emulator"."29.3.7".macosx = {
    ...
    archives = {
      macosx = fetchurl {
        url = https://dl.google.com/android/repository/emulator-darwin-6152914.zip;
        sha1 = "2081aa796afbced3e12e5bb4ae116b223e7557c8";
      };
      linux = fetchurl {
        url = https://dl.google.com/android/repository/emulator-linux-6152914.zip;
