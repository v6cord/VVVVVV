...
growing_vector<std::string> changelog = {
    ...
    "- Add an argument to createcrewman to",
    "  set a name (instead of pink/blue/etc),",
    "  useful in combination with the above",
    "  or when having multiple crewmen of the",
    "  same color",
    "- Add color aliases for all colour",
    "  functions",
    "- Add optional parameter to play to set",
    "  the fade-in time in ms (default 3000)",
    "- markmap(x, y, tile) to put a tile on",
    "  any minimap coordinate",
    "- unmarkmap(x, y) to undo the above",
    "- mapimage(path/name.png) to use any",
    "  map image",
