      ...
      if(scriptstart>-1){
        ...
        for(int i=scriptstart; i<scriptend; i++){
          ...
          if (words[0] == "music"){
            ...
            if(customtextmode==1){ add("endtext"); customtextmode=0;}
            if (words[0] == "setroomname" || words[0] == "drawtext" || words[0] == "text" || words[0] == "textcolor" || words[0] == "textcolour" || words[0] == "createroomtext" || words[0] == "customactivityzone" || words[0] == "customactivityzonergb") {
